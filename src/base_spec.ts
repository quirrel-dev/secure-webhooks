...
-----END RSA PRIVATE KEY-----
  `.trim();
      ...
      await testWithKeyPair(
        ...
        publicKey,
        privateKey,
        `v=1600000000000,d=${epxectedAsymmetricDigest}`
      );
    });
  }
